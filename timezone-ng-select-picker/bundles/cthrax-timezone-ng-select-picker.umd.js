(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@cthrax/timezone-map-picker'), require('@ng-select/ng-select'), require('@angular/platform-browser'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@cthrax/timezone-ng-select-picker', ['exports', '@angular/core', '@cthrax/timezone-map-picker', '@ng-select/ng-select', '@angular/platform-browser', '@angular/forms'], factory) :
    (global = global || self, factory((global.cthrax = global.cthrax || {}, global.cthrax['timezone-ng-select-picker'] = {}), global.ng.core, global.timezoneMapPicker, global.ngSelect, global.ng.platformBrowser, global.ng.forms));
}(this, (function (exports, core, timezoneMapPicker, ngSelect, platformBrowser, forms) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TimezoneNgSelectPickerService = /** @class */ (function () {
        ...
        /** @nocollapse */ TimezoneNgSelectPickerService.ngInjectableDef = core.ɵɵdefineInjectable({ factory: function TimezoneNgSelectPickerService_Factory() { return new TimezoneNgSelectPickerService(); }, token: TimezoneNgSelectPickerService, providedIn: "root" });
    ...
    var TimezoneNgSelectPickerComponent = /** @class */ (function () {
        function TimezoneNgSelectPickerComponent(timezoneService) {
            ...
            this.showHover = true;
            this.onTimeSelectionChange = new core.EventEmitter();
            this.groupBy = (/**
             * @param {?} item
             * @return {?}
             */
        ...
        TimezoneNgSelectPickerComponent.ctorParameters = function () { return [
            { type: timezoneMapPicker.TimezoneMapPickerService }
        ]; };
        TimezoneNgSelectPickerComponent.propDecorators = {
            defaultTimeZone: [{ type: core.Input }],
            showDropDown: [{ type: core.Input }],
            showHover: [{ type: core.Input }],
            hoverClass: [{ type: core.Input }],
            selectClass: [{ type: core.Input }],
            mapClass: [{ type: core.Input }],
            onTimeSelectionChange: [{ type: core.Output }]
        };
        ...
        TimezoneNgSelectPickerModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [
                            ...
                            forms.FormsModule,
                            timezoneMapPicker.TimezoneMapPickerModule
                        ],
    ...
    exports.TimezoneNgSelectPickerComponent = TimezoneNgSelectPickerComponent;
    exports.TimezoneNgSelectPickerModule = TimezoneNgSelectPickerModule;
    exports.TimezoneNgSelectPickerService = TimezoneNgSelectPickerService;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=cthrax-timezone-ng-select-picker.umd.js.map
