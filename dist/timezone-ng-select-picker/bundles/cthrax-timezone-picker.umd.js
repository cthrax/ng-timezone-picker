(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('timezone-map-picker'), require('@ng-select/ng-select'), require('@angular/platform-browser'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('@cthrax/timezone-picker', ['exports', '@angular/core', 'timezone-map-picker', '@ng-select/ng-select', '@angular/platform-browser', '@angular/forms'], factory) :
    (global = global || self, factory((global.cthrax = global.cthrax || {}, global.cthrax['timezone-picker'] = {}), global.ng.core, global.timezoneMapPicker, global.ngSelect, global.ng.platformBrowser, global.ng.forms));
...
//# sourceMappingURL=cthrax-timezone-picker.umd.js.map
